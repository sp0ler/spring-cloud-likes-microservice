...
== Стек
```
Java 11, Spring Boot, Spring Netflix-Eureka Server, Spring Gateway при поддержке Spring WebFlux, Spring MVC, Spring Data JPA Prometheus и Grafana, PostgreSQL, Lombok
```
